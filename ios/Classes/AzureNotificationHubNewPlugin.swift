...
public class AzureNotificationHubNewPlugin: NSObject, FlutterPlugin, UNUserNotificationCenterDelegate {
  public static func register(with registrar: FlutterPluginRegistrar) {
    let channel = FlutterMethodChannel(name: "azure_notification_hub_new", binaryMessenger: registrar.messenger())
    let instance = AzureNotificationHubNewPlugin()
